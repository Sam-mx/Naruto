      ...
      <div className="container relative" ref={parallaxRef}>
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[3.875rem] md:mb-20 lg:mb-[6.25rem]">
          <h1 className="h1 mb-6 ">
            ...
            <span className="inline-block relative text-color-7">
              Konoha{" "}
              <img
                src={curve}
        ...
        <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
          ...
          <div className="absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[67%] sm:-top-[75%] max-sm:-top-[80%] md:w-[138%] lg:-top-[104%]">
            <img
              src={herobackground}
              className="w-full"
              width={1440}
